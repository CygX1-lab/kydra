...
struct qt_meta_stringdata_ReviewWidget_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ReviewWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ReviewWidget_t qt_meta_stringdata_ReviewWidget = {
    {
QT_MOC_LITERAL(0, 0, 12) // "ReviewWidget"
...
static const uint qt_meta_data_ReviewWidget[] = {
...
QT_INIT_METAOBJECT const QMetaObject ReviewWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<PackageWidget::staticMetaObject>(),
    qt_meta_stringdata_ReviewWidget.data,
    qt_meta_data_ReviewWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ReviewWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ReviewWidget.stringdata0))
